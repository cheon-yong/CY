...
#include "CYGamePhaseAbility.generated.h"

/**
 * 
 */
UCLASS(Abstract, HideCategories = Input)
class CY_API UCYGamePhaseAbility : public UCYGameplayAbility
{
	GENERATED_BODY()
	
public:
	UCYGamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "CY|Game Phase")
