...
#include "UI/Foundation/CYActionWidget.h"
...
FSlateBrush UCYActionWidget::GetIcon() const
{
...
UEnhancedInputLocalPlayerSubsystem* UCYActionWidget::GetEnhancedInputSubsystem() const
{
