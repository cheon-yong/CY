...
#include "UI/FrontEnd/CYFrontEndComponent.h"
...
UCYFrontEndComponent::UCYFrontEndComponent(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UCYFrontEndComponent::BeginPlay()
{
	Super::BeginPlay();
...
void UCYFrontEndComponent::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	Super::EndPlay(EndPlayReason);
}

bool UCYFrontEndComponent::ShouldShowLoadingScreen(FString& OutReason) const
{
...
void UCYFrontEndComponent::Initialize()
{
...
void UCYFrontEndComponent::OnUserInitialized(const UCommonUserInfo* UserInfo, bool bSuccess, FText Error, ECommonUserPrivilege RequestedPrivilege, ECommonUserOnlineContext OnlineContext)
{
...
void UCYFrontEndComponent::FlowStep_WaitForUserInitialization(FControlFlowNodeRef SubFlow)
{
...
void UCYFrontEndComponent::FlowStep_TryShowPressStartScreen(FControlFlowNodeRef SubFlow)
{
...
void UCYFrontEndComponent::FlowStep_TryJoinRequestedSession(FControlFlowNodeRef SubFlow)
{
...
void UCYFrontEndComponent::FlowStep_TryShowMainScreen(FControlFlowNodeRef SubFlow)
{
	if (UPrimaryGameLayout* RootLayout = UPrimaryGameLayout::GetPrimaryGameLayoutForPrimaryPlayer(this))
	{
		constexpr bool bSuspendInputUntilComplete = true;
